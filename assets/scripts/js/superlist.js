$(document).ready(function() {
     ...
     */
    $('#listing-detail-location a[data-toggle="tab"]').on('http://preview.byaviators.com/template/superlist/assets/js/shown.bs.tab', function (e) {
    ...
    $('#input-file').fileinput({
        initialPreview: [
            "<img src='assets/img/tmp/product-1.jpg'/*tpa=http://preview.byaviators.com/template/superlist/assets/js/assets/img/tmp/product-1.jpg*/ class='file-preview-image' alt='Listing 1' title='Listing 1'>",
            "<img src='assets/img/tmp/product-2.jpg'/*tpa=http://preview.byaviators.com/template/superlist/assets/js/assets/img/tmp/product-2.jpg*/ class='file-preview-image' alt='Listing 2' title='Listing 2'>"
        ],
